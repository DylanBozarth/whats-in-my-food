    ...
    try {
      ...
      if (lookingForThings && lookingForThings.length > 0) {
        ...
        matches.forEach((match) => {
          console.log(
            `Match: "${match.searchTerm}" found in "${match.foundIn}" (${(match.score * 100).toFixed(
              1,
            )}% similarity, strategy: ${match.strategy})`,
          )
        })
                  ...
                  return (
                    <View key={index} style={styles.enhancedMatchedItem}>
                      ...
                      <View style={styles.ingredientInfoContainer}>
                        ...
                        {match.foundIn && match.foundIn !== match.ingredient && match.score < 1.0 && (
